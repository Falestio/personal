...
thumbnail: "/blog/idcloudhost-autoscaling/thumbnail-artikel.png"
---

# Pengembangan Autoscaling Horizontal pada IDCloudHost Menggunakan Traefik Sebagai Load Balancer dan Grafana Alert
...
:image-display{src="/blog/idcloudhost-autoscaling/graph-load-fluktuatif.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/create-network.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/set-default.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/service-highlighted.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/traefik-highlighted.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/traefik-file.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/monitoring-highlighted.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/webhook-handler-highlighted.png"}

1.  Buat API Token untuk mengakses IDCloudHost API:

    Pergi ke halaman access lalu klik tombol "Create New Access".

    :image-display{src="/blog/idcloudhost-autoscaling/create-new-access.png"}
    ...
    :image-display{src="/blog/idcloudhost-autoscaling/api-token.png"}
...
2. Tambah Prometheus sebagai sumber data
   ...
   :image-display{src="/blog/idcloudhost-autoscaling/add-data-source.png"}

   Pilih **Prometheus** sebagai data source.

   :image-display{src="/blog/idcloudhost-autoscaling/pilih-prometheus.png"}
   ...
   :image-display{src="/blog/idcloudhost-autoscaling/pesan-sukses-prometheus.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/import-dashboard-grafana.png"}

Lalu klik tombol "Import dashboard"

2. Pada halaman import dashboard masukan id Node Exporter Full dan klik "Load"

   :image-display{src="/blog/idcloudhost-autoscaling/import-dashboard-id.png"}

3. Beri nama dashboard dan pilih Prometheus sebagai datasource lalu klik import

   :image-display{src="/blog/idcloudhost-autoscaling/import-dashboard-pick-datasource.png"}

4. Jika dashboard berhasil dikonfigurasi maka akan memunculkan semua matrik yang disajikan oleh Node Exporter

   :image-display{src="/blog/idcloudhost-autoscaling/grafana-dashboard-finish.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/contact-point-menu.png"}

Berikut konfigurasi contact point untuk setiap event scaling

#### 1. Contact Point Untuk Event Scale Down

:image-display{src="/blog/idcloudhost-autoscaling/scaledown-contactpoint.png"}

#### 2. Contact Point Untuk Event Scale Up

:image-display{src="/blog/idcloudhost-autoscaling/scaleup-contactpoint.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/query-and-threshold.png"}

#### 3. Scale Up: Set Evaluation Behaviour

:image-display{src="/blog/idcloudhost-autoscaling/set-eval-behaviour.png"}

#### 4. Scale Up: Configure Labels and Notification

Pilih contact point scale up yang sudah dibuat pada bagian sebelumnya

:image-display{src="/blog/idcloudhost-autoscaling/label-and-notification.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/query-and-threshold-scaledown.png"}

#### 3. Scale Down: Set Evaluation Behaviour

:image-display{src="/blog/idcloudhost-autoscaling/set-eval-behaviour-scaledown.png"}
:image-display{src="/blog/idcloudhost-autoscaling/mute-timing-scaledown.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/graph-load-cpu.png"}
...
:image-display{src="/blog/idcloudhost-autoscaling/hasil-load-testing.png"}

Berikut adalah perbandingan dari kedua grafik tersebut.
:image-display{src="/blog/idcloudhost-autoscaling/perbandingan-graph-testing.png"}
